...
class ParserGUI:
    def __init__(self):
        ...
        self.cell = list() # Cell is a list of row objects(list of tkinter object) that contain extractions
        self.height = 1 # This is the "Height" of the stack of cells that make up our various expressions
        self.r = tk.Tk()
    ...
    def set_table(self, f):
        ...
        for line in f:
            ...
            # deleting previous garbage values/tkinter objects
    ...
    def add_row(self):
        ...
        self.cell[self.height][3].grid(row=self.height, column=3)
            #Adding a button to exit this row
